...
# CSV logging
# -----------------------------
CSV_PATH = "dual_arm_scooping_timestamp_based_log.csv"
...
# -----------------------------
# Scooping motion: both arms follow arc trajectory simultaneously
# Simulates synchronized scooping action in cooking

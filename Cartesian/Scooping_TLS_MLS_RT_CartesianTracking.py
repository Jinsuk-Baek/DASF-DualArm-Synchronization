...
CSV_PATH = "scooping_tls_mls_rt_cartesian_tracking_log.csv"
...
TASK_PATTERN: List[Tuple[str, Tuple[float, float, float]]] = [
    ("Reach-Out",    (70.0,  0.0, -25.0)),
    ("Scoop-Down",   (80.0,  0.0, -35.0)),
    ("Scoop-In",     (40.0, 20.0, -20.0)),
    ("Lift-Up",      (20.0, 20.0,  20.0)),
    ("Hold-Center",  (30.0, 10.0,  15.0)),
    ("Pour-Forward", (70.0, 10.0,  10.0)),
    ("Retract",      (30.0,  0.0,   5.0)),
    ("Return",       ( 0.0,  0.0,   0.0)),
]
...
def run_task_like_demo(
    ...
    print(
        ...
        f"{EXPERIMENT_LABEL} Scooping experiment..."
    )

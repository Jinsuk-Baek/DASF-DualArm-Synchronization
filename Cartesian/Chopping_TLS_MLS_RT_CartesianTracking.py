...
CSV_PATH = "chopping_tls_mls_rt_cartesian_tracking_log.csv"
...
TASK_PATTERN: List[Tuple[str, Tuple[float, float, float]]] = [
    ("Chop-Down-1", (0.0, 0.0, -35.0)),
    ("Chop-Up-1",   (0.0, 0.0,  35.0)),
    ("Chop-Down-2", (0.0, 0.0, -35.0)),
    ("Chop-Up-2",   (0.0, 0.0,  35.0)),
    ("Chop-Down-3", (10.0, 0.0, -30.0)),
    ("Chop-Up-3",   (10.0, 0.0,  30.0)),
    ("Chop-Down-4", (10.0, 0.0, -30.0)),
    ("Return",      (0.0, 0.0,   0.0)),
]
...
def run_task_like_demo(
    ...
    print(
        ...
        f"{EXPERIMENT_LABEL} Chopping experiment..."
    )

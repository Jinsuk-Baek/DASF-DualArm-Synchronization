...
# CSV logging
# -----------------------------
CSV_PATH = "dual_arm_tls_mls_log.csv"
...
def run_task_like_demo(
    ...
    print(f"\n[DEMO] Running 4-phase task-like synchronized Cartesian demo for {duration_sec:.1f} seconds...")
    start_t = now()
    step = 0
    ...
    print("[DEMO] Task-like Cartesian demo completed.")
    return record_id

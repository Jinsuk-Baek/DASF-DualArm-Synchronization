...
# CSV logging
# -----------------------------
CSV_PATH = "dual_arm_chopping_timestamp_based_log.csv"
...
# -----------------------------
# Chopping motion: both arms repeatedly move up and down simultaneously
# Simulates synchronized chopping/cutting action in cooking
